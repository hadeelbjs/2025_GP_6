...
class _LinksScreenState extends State<LinksScreen> {
  ...
  final FocusNode _linkFocusNode = FocusNode(); // إضافة FocusNode
  File? _selectedFile;
  ...
  void dispose() {
    ...
    _linkFocusNode.dispose(); // تنظيف FocusNode
    super.dispose();
  }
  ...
  Future<void> _handleScan() async {
    ...
    if (_selectedFile != null) {
      ...
      code = _linkController.text.trim();
    }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        // إخفاء الكيبورد عند الضغط في أي مكان
        _linkFocusNode.unfocus();
        FocusScope.of(context).unfocus();
      },
      child: Directionality(
        textDirection: TextDirection.rtl,
        child: SingleChildScrollView(
          // إضافة keyboardDismissBehavior لإخفاء الكيبورد عند السكرول
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    ...
                    maxLines: 3,
                    textInputAction: TextInputAction.done, // إضافة زر Done
                    onSubmitted: (_) {
                      // إخفاء الكيبورد عند الضغط على Done
                      _linkFocusNode.unfocus();
                    },
